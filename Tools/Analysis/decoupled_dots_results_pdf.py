...
BASE   = os.path.normpath(os.path.join(os.path.dirname(__file__), '../../Agents'))
IN_MD  = os.path.join(BASE, 'Literature', 'decoupled_dots_results.md')
OUT_PDF = os.path.join(BASE, 'WriteUps', 'decoupled_dots_results.pdf')
