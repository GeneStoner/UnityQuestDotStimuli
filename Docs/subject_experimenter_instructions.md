...
- Ensure USB debugging is enabled (one-time setup — see [handbook.md](handbook.md)).
...
- Remind the observer of the fixation instruction and the two-stage response procedure (see Part 1 above, or hand them the quick reference card at the end of Part 1).
...
See [handbook.md](handbook.md), section 3, for what each file contains.
