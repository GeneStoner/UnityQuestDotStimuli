...
| [performance_factors.md](performance_factors.md) | What limits performance and the size of the cueing effect: colour asymmetry, operating point (d'), response errors, lapses, fixation, stimulus sampling, and what to do about each | Co-authors |
