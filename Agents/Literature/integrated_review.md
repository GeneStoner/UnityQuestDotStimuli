...
**6a. Stoner, Mitchell, Fallah & Reynolds (2005). *Progress in Brain Research* 149:227–234.**
Review chapter placing Mitchell (2004) in the biased-competition framework. Argues that both voluntary attention and binocular rivalry involve competitive selection among visual representations, and that the translating-dot cue biases competition at the level of surface representations — not at the level of spatial locations, eyes, or features. Compares exogenous (automatic) vs. endogenous (voluntary) attention effects on initial rivalry dominance and switches: exogenous onset cues drive initial dominance (Mitchell 2004); endogenous attention can modulate switching rates and dominance duration separately. This two-component framing (initial dominance vs. ongoing dynamics) is relevant to VRDots, where the onset cue is exogenous but its effects persist across a 300 ms window.

**6b. Paffen, Alais & Verstraten (2006). *Psychological Science* 17:752–756.**
Showed that dividing attention (concurrent demanding task) slows rivalry alternation rate, and that directing attention to the rival display speeds alternation. Attention modulates the *dynamics* of rivalry (rate of alternation), not just which percept is initially dominant. Cites Mitchell (2004) as the dominance-cueing anchor. The mechanism is distinct: initial dominance is set by competitive weighting at onset; ongoing switching dynamics reflect a separate oscillatory process that attention can modulate by altering the balance between the two representations over time. *Moderate relevance to VRDots* — VRDots' cueing effect is about initial surface selection within a single trial (no alternation), but the dynamics result shows that sustained attention to a surface has real consequences for its competitive status, which may matter for longer-ISI trials.

**7. Mitchell, Stoner, Fallah & Reynolds (2003). *Vision Research*.**
Demonstrated that surface-based cueing persists when both transparent fields have the same color, ruling out color-channel gain as a *necessary* mechanism (p > .05 on all measures; first judgment 74.5% vs. 74.0%, same-surface second judgment 69.0% vs. 69.2%). Selection cannot be reduced to any feature dimension that merely distinguishes the two surfaces. *Nuance (from direct paper reading, 2026-04-01)*: Graphical inspection (Fig. 2 vs. Fig. 3) suggests a slight trend toward less impairment at short ISIs in the same-color condition, not reaching significance. The study was powered to rule out color as the *sole* mechanism, not to detect a facilitative increment. §4.3 explicitly leaves open that color can facilitate segmentation (citing Croner & Albright 1997), but was redundant in this paradigm where common motion already fully segmented the surfaces. Color is not necessary — it may nonetheless be facilitative. VRDots same-color conditions may therefore slightly underestimate the cueing effect that would be seen with two-color surfaces.
...
**15 (new). Khoe, Mitchell, Reynolds & Hillyard (2008). *Journal of Vision* 8(3):18. PMID: 18484824.**
ERP study specifically under dichoptic (rivalry) viewing — the direct neural follow-up to Mitchell et al. (2004). Presented the two transparent surfaces dichoptically (one per eye) to create binocular rivalry, then probed with a second translation and recorded ERPs. Found enhanced P1 (110–160 ms, lateral extrastriate) for same-surface probes relative to different-surface probes, but only under rivalry (dichoptic) viewing — the effect was absent under monocular viewing of the same stimuli. This dissociation establishes that surface-based attention biases interocular competition at early cortical stages (~110 ms), and that the rivalry condition specifically recruits a P1-indexed mechanism not present under monocular viewing. *Key VRDots implication*: the absence of P1 modulation under monocular viewing in Khoe 2008, combined with the survival of the behavioral cueing effect in VRDots' monocular sessions (+7.1pp*), suggests the monocular cueing may recruit a later or different neural mechanism (N1-indexed, or motion-discrimination rather than interocular competition).

**16 (new). Mishra & Hillyard (2009). *Vision Research* 49:1073–1080. PMID: 18384833.**
Extended the Khoe (2008) rivalry-ERP paradigm to endogenous (voluntary) attention: observers were instructed to attend to one of the two dichoptically presented surfaces from the start of the trial, without an exogenous onset cue. Found P1 and N1 modulation (110–210 ms, lateral extrastriate) for the attended surface, confirming that voluntary surface-based selection during rivalry has the same early cortical signature as exogenously cued selection. Sources localized to V3/V3a/V4. Both exogenous (Mitchell 2004, Khoe 2008) and endogenous (Mishra 2009) attention mechanisms operate at early cortical stages and bias interocular competition similarly. *VRDots note*: in VRDots, the onset translation is an exogenous cue; once established, the observer maintains voluntary (endogenous) attention through the ~300 ms pre-target interval. Both components of the Mishra result are thus engaged.
...
- **Not solely color-channel**: Same-color conditions preserve the cueing advantage (Mitchell et al. 2003; p > .05). Color is not *necessary*; a slight facilitative role cannot be ruled out (graphical trend at short ISIs; see §4.3 of that paper; Croner & Albright 1997).
- **Not solely depth-channel — but depth may be facilitative**: No published transparent-motion study has removed depth differences as a direct test analogous to Mitchell's color removal. VRDots pilot data provides an indirect comparison: cueing is present at 0.03m (depth barely perceptible), suggesting depth is not *necessary*, but cueing effects appear stronger at 0.10m and the ZdA/ZdB results confirm that depth membership is actively incorporated into the surface representation. The V1 Point-Set model predicts depth columns add a facilitative dimension to the point-set, just as color columns do. Qian et al. (1994) and Qian & Andersen (1997) provide the neural substrate: jointly direction × disparity tuned MT populations are more separated when surfaces differ in depth, strengthening surface distinctiveness. The definitive test — within-session same-depth vs. different-depth cueing comparison — has not been done in the 2D literature and is a natural VRDots experiment.
